# Kuhesabu Kitabu cha Mwanafunzi — ADT Bundle Reference
...
**Kuhesabu Kitabu cha Mwanafunzi** — Hiki ni kitabu cha Kuhesabu cha mwanafunzi wa Darasa la Kwanza kilichoandaliwa na Taasisi ya Elimu Tanzania, hivyo kinaonekana kulenga elimu ya msingi ya awali nchini Tanzania na kimeandikwa kwa lugha ya Kiswahili. Kinafundisha stadi za msingi za hesabu kama kuhesabu, kusoma na kuandika namba kutoka 0 hadi 100, kujumlisha, kutoa, kupanga namba kwa mfuatano, kutambua makumi na mamoja, pamoja na maumbo bapa. Kitabu kinafaa kwa watoto wanaoanza kusoma na kuhesabu, na kinatumia mbinu ya kujifunza kwa vitendo kupitia mifano, vielelezo, mazoezi mengi, mafumbo ya maisha ya kila siku, na hata matumizi ya TEHAMA ili kujenga umahiri wa hatua kwa hatua.
...
```
Kuhesabu-DRS-1-PB--2023--FINAL-WAMO/
├── adt/                              # THE WEB APP
...
├── Kuhesabu-DRS-1-PB--2023--FINAL-WAMO.db                    # SQLite database (pipeline state)
├── Kuhesabu-DRS-1-PB--2023--FINAL-WAMO.pdf                   # Original source PDF
...
| `pg{NNN}_im{NNN}` | Image alt text / description | `pg009_im003` |
...
{
  "pg001_gp001_tx001": "",
  "pg009_im003": "Mvulana mmoja wa shule mwenye mkoba.",
  "gl001": "abakasi",
  "gl001_def": "Kifaa kinachotumika kuonyesha namba na kusaidia kufanya hesabu.",
  "qz001_que": "Kusoma namba hutusaidia kujua nini?",
  "qz001_o0": "1) idadi ya vitu",
  "qz001_o0_exp": "✅ Hongera! Kusoma namba hutusaidia kujua idadi ya vitu."
}
```
...
```json
{
  "abakasi": {
    "word": "abakasi",
    "definition": "Kifaa kinachotumika kuonyesha namba na kusaidia kufanya hesabu.",
    "variations": ["abakasi"],
    "emoji": "🧮🔢"
  }
}
...
```json
{
  "title": "Kuhesabu Kitabu cha Mwanafunzi",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "sw",
...
<body>
    <div id="content" class="opacity-0">
        <section role="article" data-section-type="text_and_single_image"
            ...
            <img data-id="pg009_im003" src="images/pg009_im003.png" ...>
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">Kusoma namba hutusaidia kujua nini?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="✅ Hongera! Kusoma namba hutusaidia kujua idadi ya vitu." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) idadi ya vitu</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `Kuhesabu-DRS-1-PB--2023--FINAL-WAMO.pdf` |
| Pipeline database | `Kuhesabu-DRS-1-PB--2023--FINAL-WAMO.db` (SQLite) |
